...
def load_config():
    ...
    config_path = os.path.join(base_dir, config_path = "C:/Users/USER/OneDrive/Documents/desktop/third sem/Data Importer/DataImporter/config/config.yaml")  # Correct relative path
